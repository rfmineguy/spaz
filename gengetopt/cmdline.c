...
const char *gengetopt_args_info_purpose = "Interpreter";

const char *gengetopt_args_info_usage = "Usage: <usage>";

const char *gengetopt_args_info_versiontext = "Developed by Riley Fischer";

const char *gengetopt_args_info_description = "StackLang interpreter";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ptree_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ptree_given)
    write_into_file(outfile, "ptree", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVf:p", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* .  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->ptree_given),
              &(local_args_info.ptree_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "ptree", 'p',
              additional_error))
            goto failure;
